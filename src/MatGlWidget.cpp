...
MatGlWidget::MatGlWidget(APrimitive::PrimitiveType pType, QWidget *parent) :
    QGLWidget(parent),
...
void MatGlWidget::mouseMoveEvent(QMouseEvent *event)
{
    if (isMousePressed)
    {
...
void MatGlWidget::mousePressEvent(QMouseEvent *event)
{
    isMousePressed = true;
...
void MatGlWidget::mouseReleaseEvent(QMouseEvent *)
{
    isMousePressed = false;
